...
namespace SnailRacing.Ralf.Infrastrtucture
{
    ...
    public class HtmlConverter
    {
        ...
        /// <returns></returns>
        public byte[] FromHtmlString(string html, int width = 1024, ImageFormat format = ImageFormat.Jpeg, int quality = 100)
        {
        ...
        /// <param name="quality">Output image quality 1-100</param>
        /// <returns></returns>
        public byte[] FromUrl(string url, int width = 1024, ImageFormat format = ImageFormat.Jpeg, int quality = 100)
        {
